...
def bd_fanyi(type, q, dst):
    ...
    if dst == "cn":
        # print("dst cn")
        if type == "zh-tw":
            url = 'http://api.fanyi.baidu.com' + apiurl + '?appid=' + appid + '&q=' + \
                quote(q) + '&from=' + 'cht' + '&to=' + 'zh' + \
                '&salt=' + str(salt) + '&sign=' + sign
        else:
            url = 'http://api.fanyi.baidu.com' + apiurl + '?appid=' + appid + '&q=' + \
                quote(q) + '&from=' + 'auto' + '&to=' + 'zh' + \
                '&salt=' + str(salt) + '&sign=' + sign
    elif dst == "en":
        # print("dst en")
        url = 'http://api.fanyi.baidu.com' + apiurl + '?appid=' + appid + '&q=' + \
            quote(q) + '&from=' + 'auto' + '&to=' + 'en' + \
            '&salt=' + str(salt) + '&sign=' + sign
    elif dst == "fra":
        # print("dst fr")
        url = 'http://api.fanyi.baidu.com' + apiurl + '?appid=' + appid + '&q=' + \
            quote(q) + '&from=' + 'auto' + '&to=' + 'fra' + \
            '&salt=' + str(salt) + '&sign=' + sign
    else:
        # print("......")
        url = 'http://api.fanyi.baidu.com' + apiurl + '?appid=' + appid + '&q=' + \
            quote(q) + '&from=' + 'auto' + '&to=' + 'auto' + \
            '&salt=' + str(salt) + '&sign=' + sign
    # print(url)
