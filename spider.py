...
# Date: 06/18/2019
import requests
# for join two urls and parse url
...
class Spider():
    ...
    def crawl(self, target_url):
        ...
        print("Ok, The spider has finished crawling the web at {url}".format(
            url=target_url))
    ...
    def get_interLink(self):
        return self.visted

    def get_exterLink(self):
        return self.exterLink
    ...
    def parser_url(self, current_url):
        ...
        try:
            # with test, some web need headers
            ...
            for link in soup('a'):
                ...
                newurl = urljoin(current_url, get_a_url)
